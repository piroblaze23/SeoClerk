			...
			<?php for($i = 1; $i <= $settings->total_products; $i++) { ?>
				<div class="col-sm-6 col-md-4">
                    <div class="thumbnail products margin-top-40">
                    	<div class="min-height"><img src="<?php echo SITE_URL; ?>/admin/data/images/<?php echo $data->product_img->$i; ?>" style="max-width:150px;"></div>
                        
                        <h4><?php echo stripslashes($data->product_name->$i); ?></h4>
                        <div class="caption min-height">
                            <p class="content"><?php echo stripslashes($data->product_desc->$i); ?></p> 
                        </div>  <!-- End of /.caption -->
                        ...
                        <form name="products_<?php echo $i; ?>" action="<?php echo paypal_path; ?>" method="post">
                            ...
                            <a href="javascript:document.products_<?php echo $i; ?>.submit();" class="boxed-btn gd-bg br-5 buyNow" role="button">
